...
const starsVirtualList = [
    { id: 1, name: 'First Star' },
    { id: 2, name: 'Second Star' },
    { id: 3, name: 'Third Star' }
];
...
<template>
    ...
    >
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            >
                <option v-for="(star, i) in starsVirtualList" v-bind:key="i" :value="star.id">
                    {{ star.name }}
                </option>
            </select>

            <p class="text-white">Display selected star : ID {{ selectedStar }}</p>
